...
import {CardTest} from "../components/Categories/cardTest.jsx";
    ...
    return (
        <>
            <Container
                ...
                <Box id='generalWrapper'
                     sx={{
                         display: 'flex',
                         flexDirection: 'column'
                     }}>

                    <Box id='aside&CardsWrapper'
                         sx={{
                             display: 'flex',
                             gap: '30px'
                         }}>
                        ...
                        <Box id='sorting&CardsWrapper'
                            ...
                            <Box id='sortingWrapper'
                                ...
                                <Box id='sorting'
                                    ...
                                    <Box id='sortingTitlePriceWrapper'
                                         sx={{
                                             display: 'flex',
                                             color: '#71C476',
                                             alignItems: 'center'
                                ...
                                <Box id='paginationUpWrapper'
                                     sx={{
                                         display: 'flex',
                                         alignItems: 'center',
                                         paddingRight: '20px'
                                     }}>
                                    <Pagination count={totalPage} page={numPage} color="primary" variant="outlined"
                                                shape="rounded" hidePrevButton hideNextButton boundaryCount={2}
                                                siblingCount={1} onChange={(_, num) => setNumPage(num)}/>
                                </Box>
                            </Box>
