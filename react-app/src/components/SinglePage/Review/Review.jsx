    ...
    return (
        <Box sx={{mt:"40px"}}>
            {!!productReviews && productReviews.reviews.map((item, index) => {
                ...
                return <Stack key={index} sx={{mb:"40px"}}>
                    <Stack direction="row"  justifyContent="space-between" sx={{mb:"20px"}}>
                        <Stack direction="row" spacing={2} alignItems="center" sx={{ width:'200px'}}>
                            ...
                            <Typography variant="p" component="p" gutterBottom sx={{mb: '30px', fontSize: '18px', lineHeight: '18px', fontWeight: '500', mr: "10px"}}>
                                {item.authorName}
                            </Typography>
                        </Stack>
                        ...
                        <Stack direction="row" spacing={2} alignItems="center" sx={{ paddingRight: "10px"}}>
                            <Stack direction="row" spacing={2} alignItems="center" >
                                <ThumbUpOutlinedIcon/>
                                <Typography variant="p" component="p" gutterBottom sx={{ fontSize: '16px', lineHeight: '16px', fontWeight: '400'}}>
                                    {item.countLike}
                                </Typography>
                            </Stack>
                            <Stack direction="row" spacing={2} alignItems="center" >
