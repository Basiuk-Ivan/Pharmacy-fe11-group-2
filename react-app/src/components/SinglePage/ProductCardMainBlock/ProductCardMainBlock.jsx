...
const ProductCardMainBlock = ({productItem}) => {
    ...
    return (
        <Grid container>
            <Grid item xs={12} lg={5} sx={{border: '1px solid red'}}>
                        ...
                        >
                            ...
                            >
                                <Rating
                                    ...
                                    sx={{fontSize: {xs:'10px', sm: '16px', md: '18px', lg: '18px'}}}
                                />
                            </Box>
                            <Typography sx={{fontSize: {xs:'12px', sm: '14px', md: '14px', lg: '14px'}, color: '#2FD3AE'}}>
                                    ...
                                    <Grid item xs={12} sx={{backgroundColor: '#F7FAFB', mb:"5px"}} >
                                        <Grid container justifyContent="flex-start"
                                            ...
                                            <Grid item>
                                                ...
                                                sx={{ width:"4px", height:"4px",  mr:"8px",
                                                    borderRadius:'50%',
            ...
            <Grid item xs={12} lg={3} sx={{border: '1px solid red', width: '100%'}}>
                <Grid
                    container
                    sx={{
                        paddingLeft: '30px',
                ...
                >
                    <Grid item xs={12} lg={9} sx={{paddingLeft: '0px', border:'1px solid red'}}>
