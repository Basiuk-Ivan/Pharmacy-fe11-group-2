                            ...
                            <Box>
                                <Stack direction="column">
                                    <Stack direction="row" alignItems="center"
                                        ...
                                        <span
                                            className={s.brandValue}>{goods.instruction.manufacturer.value}</span>
                                    </Stack>
                                    <Stack direction="row" alignItems="center" sx={{width: '100%'}}>
                                        <span className={s.bullet}></span>
                                        <span className={s.brandTitle}>Діюча речовина:</span>
                                        <span
                                            className={s.brandValue}>{goods.instruction.activeSubstance.value}</span>
                                    </Stack>
                                    <Stack direction="row" alignItems="center"
                                           sx={{width: '100%', backgroundColor: '#F7FAFB'}}>
                                        <span className={s.bullet}></span>
                                        ...
                                        <span
                                            className={s.brandValue}>{goods.instruction.bestBeforeDate.value}</span>
                                    </Stack>
                                </Stack>
                            </Box>
                        </Box>
                    ...
                    <Grid item lg={5} sx={{border: '1px solid #E7E9EB', width:'100%'}}>
                        ...
                        <Grid container sx={{
                            ...
                            <Box sx={{position:'relative', mb:'14px'}}>
                                ...
                                <ButtonBase onClick={handleIncrement} sx={{
                                    position: 'absolute',
                                    width: '20px',
                                    height: '14px',
                                    top: '10px',
                        ...
                        <Stack
                            ...
                            sx={{mb:'12px'}}
                        >
                            <Button variant="outlined" onClick={handleDecrement} sx={{
                                margin: '25px 0 17px',
                                color: '#525A68',
                                borderRadius: '50px',
                                width:'240px',
