...
import {closeOrderModal, removeItem} from "../../../redux/slice/cartItems.js";
  ...
  const isOpenedOrderModal = useSelector(state => state.itemCards.isOpenedOrderModal);
    ...
    return(
        <Container>
            ...
            <ModalWindow mainText="Дякуємо за замовлення!"
                         handleClick={()=>{}} handleClose={handleCloseOrderModal}
                         isOpened={isOpenedOrderModal} actions={false}/>
        </Container>
    )
};
